...
server.get('Show', cache.applyShortPromotionSensitiveCache, consentTracking.consent, function (req, res, next) {
    ...
    //iterator = systemobject.querySystemObject('Product','', null);
    //while (iterator.hasNext()) {
        //var so = iterator.next();
        //var y = so.custom.pid.toString();
        ...
        // else {
        //     flag = false;
        //     res.redirect(URLUtils.url('Search-Show', 'pid').toString() + product + '&success=done');
        // }
    ...
    // var product = ProductMgr.getProduct(25565121);
    // if (product.custom.latestArrivalproducts !== true) {
    //     result.productSearch.count = 0;
    ...
    //result.schemaData.itemListElement = []
